local LrDialogs=import'LrDialogs';local LrView=import'LrView';local LrPrefs=import'LrPrefs'
return function()
  local f=LrView.osFactory();local prefs=LrPrefs.prefsForPlugin()
  local c=f:column{bind_to_object=prefs,spacing=f:control_spacing(),
    f:static_text{title='WildlifeAI Preferences',size='large'},
